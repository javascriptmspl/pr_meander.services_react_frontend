                ...
                <div className="col text-right">
                  <ul className="list-inline-item pl-0">
                    ...
                    <li className="list-inline-item">
                      <button className="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-toggle="modal" data-target="#add_contact">New Contact</button>
                    </li>
                  </ul>
                </div>
              </div>
