...
// Import Images
import { Specialities_05,provider_thumb_02,UserAvatar,UserAvatar1,UserAvatar2,
              ...
              <div className="col-md-12 col-12">
                <nav aria-label="breadcrumb" className="page-breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Stylists Profile</li>
                  </ol>
                </nav>
                <h2 className="breadcrumb-title">Stylists Profile</h2>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="provider-widget">
                  <div className="doc-info-left">
                    ...
                    <div className="doc-info-cont">
                      <h4 className="doc-name">Conley Hagen</h4>
                      <p className="doc-speciality">Makeup Specialist</p>
                      <p className="doc-department"><img src={Specialities_05} className="img-fluid" alt="Speciality" />Makeup Specialist</p>
                ...
                <div className="tab-content pt-0">
                              ...
                              <li>
                                ...
                                <div className="experience-content">
                                  <div className="timeline-content">
                                    <a href="#/" className="name">Golden West University</a>
                                    <div>Cosmetology</div>
                          ...
                          <div className="experience-box">
                            <ul className="experience-list">
                              <li>
                                ...
                                <div className="experience-content">
                                  <div className="timeline-content">
                                    <a href="#/" className="name">Bijin Salon &amp; Spa</a>
                                    <span className="time">2015 - Present (5 years)</span>
                                  </div>
                                </div>
                              </li>
                              <li>
                                ...
                                <div className="experience-content">
                                  <div className="timeline-content">
                                    <a href="#/" className="name">Fringe Hair Cut Salon</a>
                              ...
                              <li>
                                ...
                                <div className="experience-content">
                                  <div className="timeline-content">
                                    <a href="#/" className="name">Illusions Color Beauty Salon</a>
                          ...
                          <div className="experience-box">
                            <ul className="experience-list">
                              <li>
                                ...
                                <div className="experience-content">
                                  <div className="timeline-content">
                                    ...
                                    <h4 className="exp-title">Global Hairdressing Award</h4>
                              ...
                              <li>
                                ...
                                <div className="experience-content">
                                  <div className="timeline-content">
                                    ...
                                    <h4 className="exp-title">Certificate for Glamour Beauty Service</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
                                  </div>
                                </div>
                              </li>
                              <li>
                                ...
                                <div className="experience-content">
                                  <div className="timeline-content">
                                    <p className="exp-year">Jun 2009</p>
                                    <h4 className="exp-title">National Hair &amp; Beauty Awards</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
                                  </div>
                                </div>
                              </li>
                  ...
                  <div role="tabpanel" id="doc_locations" className="tab-pane fade">
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="clinic-content">
                            <h4 className="clinic-name"><a href="#">Smile Cute Makeup Center</a></h4>
                            ...
                            <div className="clinic-details mb-0">
                              <h5 className="clinic-direction"> <i className="fas fa-map-marker-alt" /> 2286  Sundown Lane, Austin, Texas 78749, USA <br /><a href="">Get Directions</a></h5>
                              <ul>
                                <li>
                                  <a href={Feature_01} data-fancybox="gallery2">
                                    <img src={Feature_01} alt="Feature Image" />
                                  </a>
                                </li>
                                <li>
                                  <a href={Feature_02} data-fancybox="gallery2">
                                    <img src={Feature_02} alt="Feature Image" />
                                  </a>
                                </li>
                                <li>
                                  <a href={Feature_03} data-fancybox="gallery2">
                                    <img src={Feature_03} alt="Feature Image" />
                                  </a>
                                </li>
                                <li>
                                  <a href={Feature_04} data-fancybox="gallery2">
                                    <img src={Feature_04} alt="Feature Image" />
                                  </a>
                                </li>
                              </ul>
                            </div>
                    ...
                    <div className="location-list">
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="clinic-content">
                            <h4 className="clinic-name"><a href="#">The Family Makeup Specialistry Clinic</a></h4>
                            <p className="doc-speciality">Hairdressing</p>
                            <div className="rating">
                              <i className="fas fa-star filled" />
                              <i className="fas fa-star filled" />
                            ...
                            <div className="clinic-details mb-0">
                              <p className="clinic-direction"> <i className="fas fa-map-marker-alt" /> 2883  University Street, Seattle, Texas Washington, 98155 <br /><a href="">Get Directions</a></p>
                              <ul>
                                <li>
                                  <a href={Feature_01} data-fancybox="gallery2">
                                    <img src={Feature_01} alt="Feature Image" />
                  ...
                  <div role="tabpanel" id="doc_reviews" className="tab-pane fade">
                      ...
                      <ul className="comments-list">
                        ...
                        <li>
                          <div className="comment">
                            <img className="avatar avatar-sm rounded-circle" alt="User Image" src={UserAvatar} />
                          ...
                          <ul className="comments-reply">
                            <li>
                              <div className="comment">
                                <img className="avatar avatar-sm rounded-circle" alt="User Image" src={UserAvatar1} />
                                <div className="comment-body">
                                  <div className="meta-data">
                                    <span className="comment-author">Faviola Stegall</span>
                        ...
                        <li>
                          <div className="comment">
                            <img className="avatar avatar-sm rounded-circle" alt="User Image" src={UserAvatar2} />
                            <div className="comment-body">
                              <div className="meta-data">
                    ...
                    <div className="write-review">
                      <h4>Write a review for <strong>Conley Hagen</strong></h4>
                      {/* Write Review Form */}
                      <form>
