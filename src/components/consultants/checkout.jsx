                      ...
                      <div className="payment-widget">
                        ...
                        <div className="terms-accept">
                          <div className="custom-checkbox">
                            <input type="checkbox" id="terms_accept" className="mr-0" />
                        ...
                        <div className="submit-section mt-4">
                          <button type="submit" className="btn btn-primary submit-btn">
                            <Link style={{color:"white"}} to="/booking-success">Confirm and Pay</Link></button>
                        </div>
                        {/* /Submit Section */}
                      </div>
                    </div>
                ...
                <div className="card booking-card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="booking-doc-info">
                      <Link to="/stylist-profile" className="booking-pro-img">
                        <img src={provider_thumb_02} alt="User Image" />
                      </Link>
                      <div className="booking-info">
                        <h4><Link to="/stylist-profile">Conley Hagen</Link></h4>
