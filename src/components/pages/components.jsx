...
// Import Image
import { Img_01,UserAvatar2,UserAvatar3,UserAvatar8 } from '../imagepath';
                ...
                <div className="row">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        <div className="avatar avatar-xxl">
                          <img className="avatar-img rounded-circle" alt="User Image" src={UserAvatar8} />
                        </div>
                  ...
                  <div className="col-md-12">
                    <div className="card">
                      ...
                      <div className="card-body">
                        <div className="avatar">
                          <img className="avatar-img rounded" alt="User Image" src={UserAvatar8} />
                        </div>
                        <div className="avatar">
                          <img className="avatar-img rounded-circle" alt="User Image" src={UserAvatar8} />
                        </div>
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        <div className="avatar-group">
                          <div className="avatar">
                            <img className="avatar-img rounded-circle border border-white" alt="User Image" src={UserAvatar8} />
                          </div>
                          <div className="avatar">
                            <img className="avatar-img rounded-circle border border-white" alt="User Image" src={UserAvatar2} />
                          </div>
                          <div className="avatar">
                            <img className="avatar-img rounded-circle border border-white" alt="User Image" src={UserAvatar3} />
                          </div>
                          <div className="avatar">
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <div className="row row-sm align-items-center mt-3">
                      ...
                      <div className="col-6 col-sm-4 col-md-2 col-xl mb-3 mb-xl-0 mb-0">
